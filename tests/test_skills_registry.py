...
def test_skill_enabled_by_default_field() -> None:
    skill = Skill(
        skill_id="my_skill",
        name="My Skill",
        description="Does things.",
...
def test_registry_loads_markdown_skills_with_yaml_frontmatter(tmp_path: Path) -> None:
    ...
    assert skills[0].enabled_by_default is False
...
def test_analytical_skills_brief_keeps_general_analytics_as_base_workflow(
    ...
    _write_skill(
        ...
        "description: Default tabular workflow.\n"
    ...
    _write_skill(
        ...
        "description: Audit data quality.\n"
        "enabled_by_default: true\n"
        "triggers: outliers, missing values\n"
        "---\n\n"
        "### Algorithm\n1. Step one.\n\n"
        "### Rules\n- Rule one.\n",
    )
