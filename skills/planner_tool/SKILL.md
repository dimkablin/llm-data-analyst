...
### API
Вызывается с параметром `question` (не Python-sandbox). Возвращает структурированный план анализа.

### Final result protocol
Не sandbox-инструмент. Возвращает план в структурированном тексте — не требует `tool_result`.
