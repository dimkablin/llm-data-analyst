...
from agent.agent_callback import ReasoningCallbackHandler, ToolCallbackHandler
from agent.artifact import Artifact, artifact_factory
...
class Agent:
    ...
    def _create_tools(self) -> list[BaseExecTool]:
        """
