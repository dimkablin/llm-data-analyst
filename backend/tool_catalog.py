...
BUILTIN_TOOL_SPECS: tuple[ToolCatalogSpec, ...] = (
    ToolCatalogSpec(
        tool_key="db_tool",
        tool_label="DB Tool",
        display_name_ru="Доступ к БД",
        description="Schema discovery and safe read-only analytic SQL over the active DB source.",
        description_ru="Исследование схемы БД и безопасные аналитические SQL-запросы только на чтение.",
        capabilities=("db_metadata", "read_only_sql", "table_preview"),
