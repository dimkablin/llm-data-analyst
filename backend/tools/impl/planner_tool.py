...
_PLANNER_SYSTEM_PROMPT = (
    ...
    "- Данные из БД или CSV получай ТОЛЬКО с sql_tool!!"
    ...
    "Планируй `get_tool_instructions(\"<skill_id>\")` ТОЛЬКО если такой analytical skill "
    "явно присутствует в переданном ниже доступном контексте / списке методов. "
    "Если analytical skills в доступном контексте не перечислены, не предлагай "
    "`get_tool_instructions` для них и не ссылайся на такие skill_id в плане.\n"
)
