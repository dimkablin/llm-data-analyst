...
- Для любых табличных задач используй только `sql_table_tool`
...
- Для табличных данных используй только `sql_table_tool`
- Не используй Python-код вместо `sql_table_tool`, если задача относится к таблицам, CSV или БД
